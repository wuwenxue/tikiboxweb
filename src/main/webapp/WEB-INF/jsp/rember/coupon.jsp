...
$(function(){
	...
	if(count==0){
		...
		for(var i=1;i<t+1;i++){
			...
			html+="<li><a href='coupon.html?page="+i+"'>"+i+"</a></li>";
		}
		html+="<li><a >&raquo;</a></li>";
	}
   		...
   		<div class="personal">
            	<div class="sidebar">
                	...
                	<ul>
                        ...
                        <li class="on"><a href="coupon.html" class="bule">我的优惠劵</a></li>
               		</ul>
                </div>
                <div class="list">
                    <p><a href="#" class="bule">全部</a>│<a href="#">未使用</a>│<a href="#">已使用</a>│<a href="#">已过期</a></p>
                    <c:forEach items="${list }" var="list">
                     <div class="coupon"><h1 class="y"><b>￥</b>${list.couponPrice }</h1><h2>${list.couponName }<br><u class="y">${list.overDate }</u></h2></div>
                    </c:forEach>
